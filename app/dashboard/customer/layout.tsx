...
import { Home, UtensilsCrossed, ShoppingBag, Heart, User, Settings, LogOut } from "lucide-react";
    ...
    <div className="flex min-h-screen bg-gray-50">
        ...
        <div className="p-6 border-b" style={{ borderColor: colors.light }}>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-teal-600 font-medium">Customer Panel</p>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col min-h-screen overflow-hidden">
        <header className="bg-white border-b px-6 lg:px-8 py-5 flex items-center justify-between sticky top-0 z-10">
          <h2 className="text-2xl font-semibold text-gray-900">Welcome Back, Rahim!</h2>
