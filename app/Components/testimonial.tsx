...
const reviews = [
  { id: 1, name: "Rahim Islam", role: "Food Blogger", text: "Foodi-এর খাবার সত্যিই অসাধারণ! বিশেষ করে তাদের সিগনেচার বার্গারটি আমার সবচেয়ে প্রিয়।", avatar: "https://i.pravatar.cc/150?u=a042581f4e29026704d" },
  { id: 2, name: "Sadia Rahman", role: "Regular Customer", text: "ডেলিভারি অনেক ফাস্ট এবং খাবারের কোয়ালিটি সবসময় প্রিমিয়াম থাকে। হাইলি রেকমেন্ডেড!", avatar: "https://i.pravatar.cc/150?u=a042581f4e29026024d" },
  { id: 3, name: "Tanvir Hasan", role: "Local Guide", text: "পরিবেশ এবং প্যাকেজিং চমৎকার। বন্ধুদের সাথে পার্টি করার জন্য সেরা একটি জায়গা।", avatar: "https://i.pravatar.cc/150?u=a04258114e29026702d" },
];
